...
<form class="form" action="createPost" method="post" name="createPostForm">
	...
	<div class="form-group row mt-3" >
		<div class="col-sm-12">
			...
			<input type="button" class="btn btn-secondary" value="등록" id="createBtn">
			<input type="button" class="btn btn-secondary" value="목록보기" onclick="location.href='getBoard?page=${page}'">
		</div>
	</div>
</form>
